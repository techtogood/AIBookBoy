    ...
    ngx_http_client_body_handler_pt post_handler)
{
    ...
    r->main->count++;
    printf(" ngx_http_read_client_request_body %d %d %d  \n",r != r->main, r->request_body ,r->discard_body);

    if (r != r->main || r->request_body || r->discard_body) {
        r->request_body_no_buffering = 0;
        printf(" ngx_http_read_client_request_body 111\n");
        post_handler(r);
        return NGX_OK;
    }
    ...
    if (r->headers_in.content_length_n < 0 && !r->headers_in.chunked) {
        r->request_body_no_buffering = 0;
        printf(" ngx_http_read_client_request_body 222\n");
        post_handler(r);
        return NGX_OK;
    }
    ...
    if (preread) {
            ...
            && rb->rest <= (off_t) (r->header_in->end - r->header_in->last))
        {
            ...
            printf(" ngx_http_read_client_request_body 1010\n");
            goto done;
        }
    ...
    if (rb->rest == 0) {
        ...
        r->request_body_no_buffering = 0;
        printf(" ngx_http_read_client_request_body 333\n");
        post_handler(r);
        return NGX_OK;
    }
	...
	printf(" ngx_http_read_client_request_body done\n");
        ...
        && (rc == NGX_OK || rc == NGX_AGAIN))
    {
        ...
        printf(" ngx_http_read_client_request_body 444\n");
        post_handler(r);
    }
