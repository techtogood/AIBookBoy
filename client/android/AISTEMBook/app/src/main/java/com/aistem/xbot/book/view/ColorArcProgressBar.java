package com.aistem.xbot.book.view;
...
import com.aistem.xbot.book.R;

/**
 * @author: aistem
 * @created: 2018/8/24/11:02
 * @desc: ColorArcProgressBar
 */
public class ColorArcProgressBar extends View {
    private int mWidth;
    private int mHeight;
    private int diameter = 15000; //直径
    ...
    private void initView() {
        ...
        vTextPaint.setColor(getResources().getColor(R.color.colorBlue));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isNeedContent) {
            canvas.drawText(String.format("%.0f", curValues) + "%", centerX, centerY * 2 / 5, vTextPaint);
        }
        if (isNeedUnit) {
