...
public class OkHttpClientManager {
    ...
    public static void getAsyn(String url, String cookie, ResultCallback callback) {
        getInstance().getGetDelegate().getAsyn(url, cookie, callback, null);
    }
    ...
    public static void getAsyn(String url, String name, String value, ResultCallback callback) {
        getInstance().getGetDelegate().getAsyn(url, name, value, callback, null);
    }
    ...
    public static void postAsyn(String url, String cookie, Param[] params, final ResultCallback callback) {
        getInstance().getPostDelegate().postAsyn(url, cookie, params, callback, null);
    }
    ...
    public static void postAsyn(String url, String key, String value, String bodyStr, final ResultCallback callback, Object tag) {
        getInstance().getPostDelegate().postAsyn(url, key, value, bodyStr, callback, tag);
    }


    public static void postAsynJson(String url, String bodyJson, final ResultCallback callback, Object tag) {
        getInstance().getPostDelegate().postAsynJson(url, bodyJson, callback, tag);
    }

    public static void postAsynJson(String url, String key, String value, String bodyJson, final ResultCallback callback, Object tag) {
        getInstance().getPostDelegate().postAsynJson(url, key, value, bodyJson, callback, tag);
    }

    public static void postAsynJson(String url, String cookie, String bodyJson, final ResultCallback callback, Object tag) {
        getInstance().getPostDelegate().postAsynJson(url, cookie, bodyJson, callback, tag);
    }

    public static Response postSyncOctetStream(String url, byte[] bodyBytes, Object tag) {
        try {
           return getInstance().getPostDelegate().post(url, bodyBytes, tag);
        }catch (IOException e){
            e.printStackTrace();
            return null;
        }
    ...
    private Request buildPostFormRequest(String url, String cookie, Param[] params, Object tag) {
        if (params == null) {
            params = new Param[0];
        }
        FormEncodingBuilder builder = new FormEncodingBuilder();
    ...
    public class PostDelegate {
         ...
         * 异步的post请求
         */
        public void postAsyn(String url, String cookie, Param[] params, final ResultCallback callback, Object tag) {
            Request request = buildPostFormRequest(url, cookie, params, tag);
            deliveryResult(callback, request);
        }
        ...
        public Response post(String url, byte[] bodyBytes, Object tag) throws IOException {
            //Log.d(TAG, "rgbData[100]=" + bodyBytes[100]+"length="+bodyBytes.length);
            RequestBody body = RequestBody.create(MEDIA_TYPE_STREAM, bodyBytes,0,bodyBytes.length);
        ...
        public void postAsyn(String url, String key, String value, String bodyStr, final ResultCallback callback, Object tag) {
            postAsynWithMediaType(url, key, value, bodyStr, MediaType.parse("application/x-www-form-urlencoded"), callback, tag);
        }
         ...
         * 直接将bodyStr以写入请求体
         */
        public void postAsynWithMediaType(String url, String key, String value, String bodyStr, MediaType type, final ResultCallback callback, Object tag) {
            RequestBody body = RequestBody.create(type, bodyStr);
            Request request = buildPostRequest(url, key, value, body, tag);
            deliveryResult(callback, request);
        }
         ...
         * 直接将bodyStr以写入请求体
         */
        public void postAsynWithMediaType(String url, String cookie, String bodyStr, MediaType type, final ResultCallback callback, Object tag) {
            RequestBody body = RequestBody.create(type, bodyStr);
            Request request = buildPostRequest(url, cookie, body, tag);
            deliveryResult(callback, request);
        }
         ...
         * 直接将Json以写入请求体
         */
        public void postAsynJson(String url, String bodyJson, final ResultCallback callback, Object tag) {
            postAsynWithMediaType(url, bodyJson, MediaType.parse("application/json;charset=utf-8"), callback, tag);
        }

        /**
         * 直接将Json以写入请求体
         */
        public void postAsynJson(String url, String key, String value, String bodyJson, final ResultCallback callback, Object tag) {
            postAsynWithMediaType(url, key, value, bodyJson, MediaType.parse("application/json;charset=utf-8"), callback, tag);
        }

        /**
         * 直接将Json以写入请求体
         */
        public void postAsynJson(String url, String cookie, String bodyJson, final ResultCallback callback, Object tag) {
            postAsynWithMediaType(url, cookie, bodyJson, MediaType.parse("application/json;charset=utf-8"), callback, tag);
        }
         ...
         * @return
         */
        private Request buildPostRequest(String url, String key, String value, RequestBody body, Object tag) {

            Request.Builder builder = new Request.Builder()
                    .url(url)
                    .header(key, value).post(body);
//            LogUtil.getInstance().e("login.l","cookie : "+cookie);
            if (tag != null) {
                builder.tag(tag);
            }
            Request request = builder.build();
         ...
         * @return
         */
        private Request buildPostRequest(String url, String cookie, RequestBody body, Object tag) {

            Request.Builder builder = new Request.Builder()
                    .url(url)
                    .header("Cookie", cookie).post(body);
//            LogUtil.getInstance().e("login.l","cookie : "+cookie);
            if (tag != null) {
                builder.tag(tag);
            }
    ...
    public class GetDelegate {
        ...
        private Request buildGetRequest(String url, String cookie, Object tag) {
        ...
        private Request buildGetRequest(String url, String name, String value, Object tag) {
            Request.Builder builder = new Request.Builder()
                    .url(url)
                    .header(name, value);
        ...
        public void getAsyn(String url, String cookie, final ResultCallback callback, Object tag) {
            final Request request = buildGetRequest(url, cookie, tag);
            getAsyn(request, callback);
        }

        public void getAsyn(String url, String name, String value, final ResultCallback callback, Object tag) {
            final Request request = buildGetRequest(url, name, value, tag);
            getAsyn(request, callback);
        }
    }
    ...
    public class DownloadDelegate {
         ...
         * @param callback
         */
        public Call downloadAsyn(final String url, final String destFileDir, final ResultCallback callback, Object tag) {
            final Request request = new Request.Builder()
                    .url(url)
                    .tag(tag)
                    .build();
        ...
        public Call downloadAsyn(final String url, final String destFileDir, final ResultCallback callback) {
           return downloadAsyn(url, destFileDir, callback, null);
        }
    }
