...
public class Config {
    ...
    public static final String endpoint_sub = "oss-cn-shenzhen.aliyuncs.com";

    public static final String endpoint1 = "http://oss-cn-hangzhou.aliyuncs.com";
    public static final String endpoint1_sub = "oss-cn-hangzhou.aliyuncs.com";
    ...
    public static final String STSSERVER = "http://192.168.51.227:7080/";//STS 地址
//    public static final String STSSERVER = "http://192.168.51.227:7080/";//STS 地址

    public static final String uploadFilePath = ""; //本地文件上传地址
    public static final String bucket = "aistem-test";
    public static final String uploadObject = "voice";
