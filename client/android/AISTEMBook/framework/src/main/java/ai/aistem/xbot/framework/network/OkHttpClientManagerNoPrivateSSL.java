...
public class OkHttpClientManagerNoPrivateSSL
{
    private static final String TAG = "OkHttpClientManagerNoPrivateSSL";

    private static OkHttpClientManagerNoPrivateSSL mInstance;
    ...
    private OkHttpClientManagerNoPrivateSSL()
    {
        mOkHttpClient = new OkHttpClient();
        mOkHttpClient.setConnectTimeout(25, TimeUnit.SECONDS);
        mOkHttpClient.setWriteTimeout(25, TimeUnit.SECONDS);
        mOkHttpClient.setReadTimeout(25, TimeUnit.SECONDS);
        //cookie enabled
    ...
    public static OkHttpClientManagerNoPrivateSSL getInstance()
    {
        if (mInstance == null)
        {
            synchronized (OkHttpClientManagerNoPrivateSSL.class)
            {
                if (mInstance == null)
                {
                    mInstance = new OkHttpClientManagerNoPrivateSSL();
                }
            }
        }
        return mInstance;
